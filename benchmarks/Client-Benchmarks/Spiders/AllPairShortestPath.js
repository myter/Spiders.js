...
class Worker extends spiders.Actor {
    constructor() {
        ...
        this.neighbours = [];
        this.graphData = null;
        this.numBlocksInSingleDim = null;
        this.numNeighbors = null;
        this.rowOffset = null;
        this.colOffset = null;
        this.k = -1;
        this.neighborDataPerIteration = [];
        this.receivedNeighbors = false;
        this.currentIterData = null;
    ...
    setup() {
        ...
        for (var i = 0; i < numBlocksInSingleDim; i++) {
            ...
            for (var j = 0; j < numBlocksInSingleDim; j++) {
                ...
                workerRef.config(myBlockId, blockSize, numNodes, benchUtils_1.BenchConfig.apspW);
...
class SpiderAllPairShortestPathBench extends benchUtils_1.SpiderBenchmark {
    constructor() {
...
exports.SpiderAllPairShortestPathBench = SpiderAllPairShortestPathBench;
//# sourceMappingURL=AllPairShortestPath.js.map