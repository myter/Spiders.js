 ...
 */
class NatFilterBankBench extends benchUtils_1.SpiderBenchmark {
    constructor() {
    ...
    runBenchmark() {
        ...
        that.integrateRef.postMessage(["config", benchUtils_1.BenchConfig.filterBankChannels], [c2.port1]);
        ...
        for (var i = 0; i < benchUtils_1.BenchConfig.filterBankChannels; i++) {
            ...
            firFilt2Ref.postMessage(["config", i + ".2", benchUtils_1.BenchConfig.filterBankColumns], [c5.port1]);
            for (var c in F[i]) {
            ...
            delayRef.postMessage(["config", i + ".2", benchUtils_1.BenchConfig.filterBankColumns - 1], [c6.port1]);
            ...
            sampleFiltRef.postMessage(["config", benchUtils_1.BenchConfig.filterBankColumns], [c7.port1]);
            ...
            firFiltRef.postMessage(["config", i + ".1", benchUtils_1.BenchConfig.filterBankColumns], [c8.port1]);
            for (var c in H[i]) {
            ...
            firstRef.postMessage(["config", i + ".1", benchUtils_1.BenchConfig.filterBankColumns - 1], [c9.port1]);
            ...
            bankRef.postMessage(["config", i, benchUtils_1.BenchConfig.filterBankColumns], [c10.port1]);
        ...
        that.producerRef.postMessage(["config", benchUtils_1.BenchConfig.filterBankSimulations], [c15.port1]);
    }
    cleanUp() {
...
exports.NatFilterBankBench = NatFilterBankBench;
