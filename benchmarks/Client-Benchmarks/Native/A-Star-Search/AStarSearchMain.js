 ...
 */
class NatAStarSearchBench extends benchUtils_1.SpiderBenchmark {
    constructor() {
    ...
    runBenchmark() {
        ...
        that.masterRef.postMessage(["config", benchUtils_1.BenchConfig.aStarWorkers, benchUtils_1.BenchConfig.aStarGridSize]);
        var id = 0;
        for (var i = 0; i < benchUtils_1.BenchConfig.aStarWorkers; i++) {
            ...
            workerRef.postMessage(["config", benchUtils_1.BenchConfig.aStarThreshold, benchUtils_1.BenchConfig.aStarGridSize], [chan.port1]);
            id += 1;
        }
...
exports.NatAStarSearchBench = NatAStarSearchBench;
