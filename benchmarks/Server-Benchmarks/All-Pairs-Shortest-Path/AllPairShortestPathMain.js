 ...
 */
class NodeAllPairShortestPathBench extends benchUtils_1.SpiderBenchmark {
    constructor() {
    ...
    runBenchmark() {
        ...
        for (var i = 0; i < numBlocksInSingleDim; i++) {
            ...
            for (var j = 0; j < numBlocksInSingleDim; j++) {
                ...
                workerRef.emit(["config", myBlockId, blockSize, numNodes, benchUtils_1.BenchConfig.apspW]);
...
exports.NodeAllPairShortestPathBench = NodeAllPairShortestPathBench;
