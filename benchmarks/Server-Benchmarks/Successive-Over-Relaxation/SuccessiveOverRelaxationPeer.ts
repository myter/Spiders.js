...
var border = 		[]
var borderPorts = []
var sorSource : ClientBufferSocket = 	null
var sorSourcePort : number = null
var gTotal = 		0.0
var returned = 		0
var totalMsgRcv = 	0
var expectingBoot = true
var sorActors : Array<ClientBufferSocket> = 	[]
var sorActorsPorts : Array<number> = []
...
function mHandle(data){
    function config(o,j,sA,ps,m,ssPort){
        ...
        sorSource 	= new ClientBufferSocket(ssPort,mHandle)
        sorSourcePort = ssPort
    }

    function addBorder(pos,borderElementPort){
        var borderElement = new ClientBufferSocket(borderElementPort,mHandle)
