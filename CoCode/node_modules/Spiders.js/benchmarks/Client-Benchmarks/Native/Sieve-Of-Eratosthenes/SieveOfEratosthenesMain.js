 ...
 */
class NatSieveOfEratosthenesBench extends benchUtils_1.SpiderBenchmark {
    constructor() {
    ...
    runBenchmark() {
        ...
        function sysHandle(event) {
            ...
            function spawnNew(id, initPrime, sender) {
                ...
                ref.postMessage(["config", id, initPrime, benchUtils_1.BenchConfig.sieveLocal]);
        ...
        that.filterRef.postMessage(["config", 1, 2, benchUtils_1.BenchConfig.sieveLocal]);
        ...
        that.producerRef.postMessage(["config", benchUtils_1.BenchConfig.sieveLimit], [c.port1]);
    }
    cleanUp() {
...
exports.NatSieveOfEratosthenesBench = NatSieveOfEratosthenesBench;
