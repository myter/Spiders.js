 ...
 */
export class NatBankTransactionBench extends SpiderBenchmark{
    tellerRef
    accounts
    ...
    runBenchmark(){
        ...
        while(accCount >= 0){
            ...
            that.tellerRef.postMessage(["newAccount",BenchConfig.bankingAccounts,BenchConfig.bankingTransactions],[chan.port1])
            newAcc.postMessage(["config",BenchConfig.bankingInitialBalance],[chan.port2])
            accCount -= 1
        }
    }
