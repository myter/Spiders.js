 ...
 */
export class NatUnbalancedCobwebbedTreeBench extends SpiderBenchmark{
    spawned
    rootRef
    ...
    runBenchmark(){
        ...
        function sysHandle(event){
            ...
            function spawnNodeP2(partId,parent){
                ...
                nodeRef.postMessage(["config",height,id,comp,urgent,BenchConfig.uctBinomial],[root])
        ...
        that.rootRef.postMessage(["config",BenchConfig.uctMaxNodes,BenchConfig.uctAvgCompSize,BenchConfig.uctStdevCompSize,BenchConfig.uctBinomial,BenchConfig.uctPercent])
    }
