...
function game(roomName,clientObject){
    ...
    function Ball(x, y, vx, vy) {
        ...
        this.draw = function() {
            ...
            ballImg.src = "/public/img/ball.png";
    ...
    function PowerUps() {
        ...
        var radius = 15;
        this.eBallSign  = new PowerupSign(width - (radius + 2), radius, radius, "green", this.extraBallPowerup, "eBallPowerup", false, "/public/img/live.png");
        this.palletSign = new PowerupSign(width - (radius + 2), (height / 2) - radius, radius, "blue", this.palletPowerup, "palletPowerup", 20, "/public/img/shield.png");
        this.mBallSign  = new PowerupSign(width - (radius + 2), height - (2 * radius) - 2, radius, "red", this.multiballPowerup, "mBallPowerup", false, "/public/img/boom.png");
...
function hideRoomListingElements() {
    ...
    document.body.style.backgroundImage = "url('/public/img/tennis_background.png')";
}
