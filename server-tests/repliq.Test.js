...
describe("Annotations", () => {
    it("Atomic method", function (done) {
        ...
        __decorate([
            spider.atomic
        ], TestRepliq.prototype, "updateField", null);
        class Master extends spider.Application {
            constructor() {
                super();
                this.repliq = this.newRepliq(TestRepliq);
    ...
    it("Built-in field annotations", function (done) {
        ...
        __decorate([
            spider.LWR
        ], TestRepliq.prototype, "lwr", void 0);
        __decorate([
            spider.Count
        ], TestRepliq.prototype, "count", void 0);
        class Master extends spider.Application {
            constructor() {
                super();
                this.repliq = this.newRepliq(TestRepliq);
    ...
    it("Custom field annotations", function (done) {
        ...
        __decorate([
            Test
        ], TestRepliq.prototype, "field", void 0);
        __decorate([
            spider.atomic
        ], TestRepliq.prototype, "updateField", null);
        class Master extends spider.Application {
...
//# sourceMappingURL=repliq.Test.js.map